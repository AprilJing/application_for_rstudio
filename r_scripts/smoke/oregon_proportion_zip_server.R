...
# This file uses Oregon WRF grid shapefile and 2013 US shapefile to make a 
# proportion of 417 zip codes and 1575 WRF grids.
...
## Oregon zip code
read_path <- paste0('../../../data/data_original/oregon_zipcode.csv') # copy from website
...
# I'm expecting a matrix of 417 zipcodes * 1575 wrf_grids 
or_zip_name <- or_zip
length(or_zip_name)
